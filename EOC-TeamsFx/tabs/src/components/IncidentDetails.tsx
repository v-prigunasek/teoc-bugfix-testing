        ...
        if (incInfo) {
            ...
            if (selectedValue.detail.length > 0) {
                ...
                selctedIncCommander.push({
                    displayName: selectedValue.detail[0] ? selectedValue.detail[0].displayName.includes(",") ? selectedValue.detail[0].displayName.split(",")[0] + " " + selectedValue.detail[0].displayName.split(",")[1] : selectedValue.detail[0].displayName : '',
            ...
            incInfo.incidentCommander = {
                userName: selectedValue.detail[0] ? selectedValue.detail[0].displayName.includes(",") ? selectedValue.detail[0].displayName.split(",")[0] + " " + selectedValue.detail[0].displayName.split(",")[1] : selectedValue.detail[0].displayName : '',
    ...
    private handleAssignedUserChange = (selectedValue: any) => {
        ...
        if (incInfo) {
            incInfo["assignedUser"] = selectedValue.detail.map((user: any) => {
                selectedUsersArr.push({
                    displayName: user.displayName.includes(",") ? user.displayName.split(",")[0] + " " + user.displayName.split(",")[1] : user.displayName,
                    userPrincipalName: user.userPrincipalName,
                    id: user.id
                });
                return {
                    "userName": user ? user.displayName.includes(",") ? user.displayName.split(",")[0] + " " + user.displayName.split(",")[1] : user.displayName : "",
                    "userEmail": user ? user.userPrincipalName : "",
                    "userId": user ? user.id : "",
                }
            });
